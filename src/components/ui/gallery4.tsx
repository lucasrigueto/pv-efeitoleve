        ...
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          ...
          <div className="hidden shrink-0 gap-2 md:flex">
            <button
              ...
              className="disabled:pointer-events-auto h-10 w-10 rounded-full flex items-center justify-center border border-neutral-700 bg-transparent text-white hover:bg-white/10 disabled:opacity-50"
            >
